...
const int setsAmount = 12; // how many sets to process
const char * resDir = "D:\\webgraph\\LM2\\"; // where to put compressed sets
const char * compressLog = "D:\\webgraph\\results\\compressLogLM2.csv"; // compression log file
const char * testLog = "D:\\webgraph\\results\\testLogLM2.csv"; // test log file
